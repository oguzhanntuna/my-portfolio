...
const ProjectItem = (props) => {
  ...
  const renderContentCover = () => (
    <div className="projectItem-contentCover">
      <div className="projectItem-description">{description}</div>
      <div className="projectItem-infoContainer">
        <div className="projectItem-additionalFeatures">
          {additionalFeatures.length > 0 && (
            <>
              <div className="projectItem-additionalFeatures-title">
                Additional Features:
              </div>
        ...
        <div className="projectItem-technologiesUsed">
          <div className="projectItem-technologiesUsed-title">
            Technologies Used:
          </div>
  ...
  return (
    <div className={`projectItem projectItem--${type}`}>
      <label className="projectItem-title">{title}</label>
      <div
      ...
      >
        <div
          className={`
                    ...
                    ${
                      deviceType === "desktop"
                        ? "projectItem-iconsContainer--desktop"
                        : "projectItem-iconsContainer--mobile"
                    }
                    ${
                      showContentCover
                        ? "projectItem-iconsContainer--active"
                        : ""
                    }
                `}
        >
          ...
          {websiteLink !== "" ? (
            <a
              className="icon icon-marginLeft"
              href={websiteLink}
              target="_blank"
              rel="noreferrer"
            >
